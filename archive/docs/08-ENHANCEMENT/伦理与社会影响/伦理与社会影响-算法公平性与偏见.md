...
- [伦理与社会影响：算法公平性与偏见](#伦理与社会影响算法公平性与偏见)
  ...
  - [七、合规性要求和实施指南](#七合规性要求和实施指南)
    - [7.1 算法公平性合规要求](#71-算法公平性合规要求)
      - [7.1.1 法规要求](#711-法规要求)
      - [7.1.2 实施指南](#712-实施指南)
    - [7.2 偏见缓解合规要求](#72-偏见缓解合规要求)
      - [7.2.1 法规要求](#721-法规要求)
      - [7.2.2 实施指南](#722-实施指南)
  - [八、相关文档](#八相关文档)
...
- [Algorithmic bias](https://en.wikipedia.org/wiki/Algorithmic_bias) - 算法偏见
- [Fairness (machine learning)](https://en.wikipedia.org/wiki/Fairness_(machine_learning)) - 机器学习公平性
- [Discrimination](https://en.wikipedia.org/wiki/Discrimination) - 歧视

#### 外部工具和资源

- [Fairness in Machine Learning](https://fairmlbook.org/) - 机器学习公平性
- [AI Fairness 360 Toolkit](https://aif360.mybluemix.net/) - AI公平性工具包
- [Fairness Definitions Explained](https://fairmlbook.org/) - 公平性定义解释

### 8.3 项目管理文档

- **[Wikipedia资源对标](../../structure_control/Wikipedia资源对标.md)** - Wikipedia资源对标
- **[概念关联网络](../../structure_control/概念关联网络.md)** - 算法公平性与偏见在概念关联网络中的位置
