...
- 在支付系统中，一个支付工作流实例 $w$ 可能表示一次完整的支付流程，从支付请求开始到最终完成或失败（参见[企业实践案例](../04-PRACTICE/企业实践案例.md)和[Saga模式专题文档](../02-THEORY/workflow/Saga模式专题文档.md)）
- 在数据处理系统中，一个工作流实例可能表示一个ETL（提取、转换、加载）任务的完整执行过程（参见[工作流模式专题文档](../02-THEORY/workflow/工作流模式专题文档.md)）
- 工作流实例的唯一标识符允许系统跟踪、查询和管理该实例的整个生命周期（参见[工作流网专题文档](../02-THEORY/workflow/工作流网专题文档.md)）

**概念2（Activity）**：Activity $a \in A$ 是工作流中的原子执行单元，具有输入参数 $a.input$ 和输出结果 $a.output$。

**实际应用示例**：

- 在支付工作流中，Activity可能包括：`ValidatePayment`（验证支付）、`DebitAccount`（扣款）、`CreditAccount`（入账）等（参见[企业实践案例](../04-PRACTICE/企业实践案例.md)和[Saga模式专题文档](../02-THEORY/workflow/Saga模式专题文档.md)）
- 每个Activity必须是**幂等的**：多次执行相同输入应该产生相同输出，这对于容错和重试机制至关重要（参见[FLP不可能定理专题文档](../02-THEORY/distributed-systems/FLP不可能定理专题文档.md)）
- Activity的超时和重试策略保证系统的可靠性，例如：`DebitAccount` Activity 的超时时间为30秒，最多重试3次（参见[Temporal选型论证](../03-TECHNOLOGY/论证/Temporal选型论证.md)）
...
**相关专题文档**：
- [CTL专题文档](../02-THEORY/formal-verification/CTL专题文档.md) - CTL计算树逻辑详细说明
- [LTL专题文档](../02-THEORY/formal-verification/LTL专题文档.md) - LTL线性时序逻辑详细说明
- [CTL-LTL扩展专题文档](../02-THEORY/formal-verification/CTL-LTL扩展专题文档.md) - CTL和LTL的扩展理论
...
**相关专题文档**：
- [TLA+专题文档](../02-THEORY/formal-verification/TLA+专题文档.md) - TLA+动作时序逻辑规范语言详细说明
- [Saga模式专题文档](../02-THEORY/workflow/Saga模式专题文档.md) - Saga模式的理论基础和实现
...
**相关专题文档**：
- [Petri网专题文档](../02-THEORY/formal-verification/Petri网专题文档.md) - Petri网并发系统建模详细说明
- [工作流网专题文档](../02-THEORY/workflow/工作流网专题文档.md) - 工作流网建模方法
...
**相关专题文档**：
- [UPPAAL专题文档](../02-THEORY/formal-verification/UPPAAL专题文档.md) - UPPAAL实时系统验证工具详细说明
