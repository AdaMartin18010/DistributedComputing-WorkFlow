...
- [Paxos算法](Paxos算法专题文档.md) - 经典共识算法对比
- [FLP不可能定理](FLP不可能定理专题文档.md) - 异步系统共识的理论限制
- [CAP定理](CAP定理专题文档.md) - 分布式系统的基本约束
- [一致性模型](一致性模型专题文档.md) - Raft的一致性保证
- [拜占庭容错](拜占庭容错专题文档.md) - 恶意故障场景下的共识

### 算法实现

- [Consensus协议对比](../../03-communication/protocol/Consensus协议对比.md) - 主流共识协议综合对比
- [etcd详解](../../工具与框架/etcd详解.md) - 基于Raft的分布式键值存储
- [ZooKeeper深度分析](../../工具与框架/ZooKeeper深度分析.md) - ZAB协议实现（类似Raft）

### 系统应用

- [TiDB架构深度分析](../../05-storage/newsql/TiDB架构深度分析.md) - TiKV中的Raft实现
- [CockroachDB架构](../../05-storage/newsql/CockroachDB架构.md) - 分布式SQL数据库共识
- [MongoDB架构](../../05-storage/nosql/MongoDB架构.md) - 副本集Raft实现
- [Redis深度分析](../../05-storage/nosql/Redis深度分析.md) - Redis Sentinel高可用

### 事务与一致性

- [2PC与3PC](../../08-transactions/2PC与3PC.md) - 分布式事务协议
- [分布式事务选型](../../08-transactions/分布式事务选型.md) - 事务处理方案选择
- [Saga模式专题文档](../workflow/Saga模式专题文档.md) - 最终一致性事务模式

### 形式化验证

- [TLA+专题文档](../formal-verification/TLA+专题文档.md) - Raft的形式化规约
