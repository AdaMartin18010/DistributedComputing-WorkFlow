...
- [两阶段提交2PC](./protocols/两阶段提交2PC.md)
- [Saga模式详解](./protocols/Saga模式详解.md)
- [TCC事务模式](./protocols/TCC事务模式.md)
- [ACID与BASE理论](./theory/ACID与BASE理论.md)

## 参考资源

- [分布式事务比较](https://medium.com/@dongfuye/comprehensive-analysis-of-distributed-transaction-solutions-7a8e69377395)
