...
- **[项目知识图谱](../17-enhancement-plan/项目知识图谱.md)** - 项目知识图谱，语境图谱的应用
- **[全局知识关联图](全局知识关联图.md)** - 全局知识关联图，与语境图谱相关

#### 核心论证文档

- **[Temporal选型论证](Temporal选型论证.md)** - Temporal选型论证，语境图谱的应用
- **[技术栈组合论证](技术栈组合论证.md)** - 技术栈组合论证，语境图谱的应用
...
- [Context (computing)](https://en.wikipedia.org/wiki/Context_(computing)) - 上下文计算
...
- **[概念关联网络](../../structure_control/概念关联网络.md)** - 语境图谱在概念关联网络中的位置
